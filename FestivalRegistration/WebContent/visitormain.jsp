...
<script language="JavaScript">var nHist = window.history.length;
			...
			<tr>
							...
							<td width="100%">
								<table align="right" cellpadding="2">
									<tr>
										...
										<td width="160">
											<div id="menu" align="center">
												<a href="<jstlcore:url value="/changePWD.jsp"/>">
													Change_Password </a>
											</div></td>
										<td width="160">
											<div id="menu" align="center">
												<a href="<jstlcore:url value="/catalog.htm"/>">
													Event_Catalog </a>
											</div></td>
										<td width="90">
											<div id="menu" align="center">
				...
				height="5" width="100%" /></div>
												...
												<h3>
													Festival Portal Page: Welcome <span
														style="background-color: yellow;"><jstlcore:out
															value="${visitor.firstName}"></jstlcore:out>
													</span> to your portal page.....
												</h3>
											</div>
														...
														<div id="coursesbody" align="left">
															<p>
																...
																change your information, <a
																	href="<jstlcore:url value="/updatevisitor.jsp?vname=${visitor.userName}&fname=${visitor.firstName}&lname=${visitor.lastName}&email=${visitor.email}&phoneno=${visitor.phoneNumber}&address=${visitor.address}"/>">click
																	here </a>
															</p>
															<p class="style1">
																Username :
															...
															<p class="style1">
																Visitor ID:
																<jstlcore:out value="${visitor.visitorId}"></jstlcore:out>
															</p>
															<p class="style1">
																Email:
											...
											<div id="content" align="center">
												...
												<table width="96%" border="1" align="center">
													...
													<jstlcore:forEach items="${regEvents}" var="regEvent">
														<tr align="center">
															<td><jstlcore:out
																	value="${fn:substring(visitor.lastName,0,4)}${fn:substring(visitor.firstName,0,3)}-${regEvent[7]}"></jstlcore:out>
															</td>
															<td align="center"><jstlcore:out
																	value="${regEvent[0]}"></jstlcore:out>
															</td>
															<td align="center"><jstlcore:out
																	value="${regEvent[1]}"></jstlcore:out>
															</td>
															<td align="center"><jstlcore:out
																	value="${regEvent[2]}"></jstlcore:out>
															</td>
															<td align="center"><jstlcore:out
																	value="${regEvent[3]}"></jstlcore:out>
															</td>
															<td align="center"><jstlcore:out
																	value="${regEvent[4]}"></jstlcore:out>
															</td>
															<td align="center"><jstlcore:out
																	value="${regEvent[5]}"></jstlcore:out>
															</td>
															<td align="center"><jstlcore:out
																	value="${regEvent[7]}"></jstlcore:out>
															</td>
															<td align="center"><jstlcore:out
																	value="${regEvent[6]}"></jstlcore:out>
															</td>
															<td width="100px" bgcolor="#CCCC99"><a
																href="<jstlcore:url value="/eventunreg.htm?eventId=${regEvent[0]}&eventsessionid=${regEvent[7]}"/>">Release</a>
															</td>
														</tr>
													</jstlcore:forEach>
													<tr>
					...
					<div id="content" align="center">
						...
						<p class="content">
							Enter eventname to search <input type="text" name="eventname"></input>
							<input type="submit" value="Search"></input>
						</p>
						<table class="content" width="96%" border="1" align="center">
							<tr bgcolor="#66CC99">
								<th scope="col">Event id</th>
								<th scope="col">Event name<br /> <a
									href="<jstlcore:url value="/displayasc.htm"/>"><img
										src="images/upointer.jpg" />
								</a> <a href="<jstlcore:url value="/displaydesc.htm"/>"><img
										src="images/dpointer.jpg" />
								</a></th>
								<th scope="col">Description</th>
								<th scope="col">Places</th>
								<th scope="col">Duration</th>
							...
							<jstlcore:forEach items="${allEvents}" var="event">
								<tr>
									<td align="center"><jstlcore:out value="${event[0]}"></jstlcore:out>
									</td>
									<td align="center"><jstlcore:out value="${event[1]}"></jstlcore:out>
									</td>
									<td align="center"><jstlcore:out value="${event[2]}"></jstlcore:out>
									</td>
									<td align="center"><jstlcore:out value="${event[5]}"></jstlcore:out>
									</td>
									<td align="center"><jstlcore:out value="${event[3]}"></jstlcore:out>
									</td>
									<td align="center"><jstlcore:out value="${event[4]}"></jstlcore:out>
									</td>
									<td align="center"><jstlcore:out value="${event[7]}"></jstlcore:out>
									</td>
									<td align="center"><jstlcore:out value="${event[6]}"></jstlcore:out>
									</td>
									<jstlcore:choose>
										<jstlcore:when test="${event[6] != 0}">
											<td width="100px" bgcolor="#CCCC99" align="center"><jstlcore:out
													value="${event[6]}"></jstlcore:out> <strong> seats
													left.</strong> <a
												href="<jstlcore:url value="/eventreg.htm?eventId=${event[0]}&sessionId=${event[7]}"/>">Register</a>
											</td>
										</jstlcore:when>
										<jstlcore:otherwise>
