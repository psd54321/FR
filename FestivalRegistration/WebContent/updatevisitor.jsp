...
<%@page import="com.festival.adf.businesstier.entity.Visitor"%>
<html>
<head>
			...
			<tr>
				<td>
					<div id="header">
						&nbsp;
						<div align="center">
							<a href="<jstlcore:url value="/login.htm"/>"> Festival
							...
							<td width="100%">
								<table align="right" cellpadding="2">
									<tr>
										...
										<td width="90">
											<div id="menu" align="center">
												<a href="<jstlcore:url value="/about.htm"/>"> About</a><br />
											</div>
										</td>
									</tr>
								</table>
									...
									<tbody>
										...
										<tr>
											...
											<td><input type="text" value="<%=fname%>"
												name="firstname" size="25"></input></td>
										</tr>
										<tr>
											<td>Last Name:</td>
										...
										<tr>
											<td>User Name:</td>
											<td><input type="text" value="<%=uname%>"
												disabled="disabled" size="25"></input> <input type="hidden"
												value="<%=uname%>" name="username" /></td>
										</tr>
										<!-- <tr>
											<td><span
										...
										<tr>
											<td>Email:</td>
											<td><input type="text" value="<%=email%>" name="email"
												size="25"></input></td>
										</tr>
										<tr>
											<td>Phone Number:</td>
											<td><input type="text" value="<%=phoneno%>"
												name="phoneno" size="25"></input></td>
										</tr>
										<tr>
											<td>Address:</td>
											<td><input type="text" name="address"
												value="<%=address%>" size="25"></input></td>
										</tr>

										<tr>
											<td colspan="2" align="right"><input value="Cancel"
												type="Button" onclick="cancelUpdate()"> <input
